...
@Autonomous(name="live laugh specimen", group="Linear Opmode")


public final class NewBestAuto extends LinearOpMode {
    public class Lift {
        ...
        Actions.runBlocking(new SequentialAction(
                ...
                new ParallelAction(
                        ...
                        drive.actionBuilder(new Pose2d(-54, 65, Math.toRadians(-90)))
                                ...
                                .splineToConstantHeading(new Vector2d(0, -6), Math.toRadians(-90))
                                .build()
                ),
                new SleepAction(0.4),
                lift.hangSpecimen(),
                new ParallelAction(
                        pickup.prepareForSpecimen(),
                        lift.liftDown(),
                        drive.actionBuilder(new Pose2d(0, -6, Math.toRadians(-90)))
                                .setTangent(Math.toRadians(90))
                                .splineToConstantHeading(new Vector2d(-40, 85), Math.toRadians(90))
                                .build()
                ),
                new ParallelAction(
                ...
                new ParallelAction(
                        ...
                        drive.actionBuilder(new Pose2d(-2, 15, Math.toRadians(-90)))
                                .setTangent(Math.toRadians(90))
                                .splineToConstantHeading(new Vector2d(-40, 85), Math.toRadians(180))
                                .build()
                )
        ));
    }
