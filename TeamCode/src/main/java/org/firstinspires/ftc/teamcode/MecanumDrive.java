...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.0013268273396960311;
        public double trackWidthTicks = 7583.754333450516;

        // feedforward parameters (in tick units)
        public double kS = 1.0070479965151224;
        public double kV = 0.0003699793812772738;
